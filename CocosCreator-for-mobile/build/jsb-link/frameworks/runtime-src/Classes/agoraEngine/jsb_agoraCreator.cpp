...
public:
    se::Object* _refObj;
    agora::cocos::MyVideoRawDataControl* _myVideoRawDataControl;
...
{
    _myVideoRawDataControl = NULL;
}

CagoraCreatorJsWrapper::~CagoraCreatorJsWrapper()
{
    if (_myVideoRawDataControl)
    {
        delete _myVideoRawDataControl;
        _myVideoRawDataControl = NULL;
    }
}
...
static bool js_cocos2dx_extension_agoraCreator_enableVideo(se::State& s)
{
    CCLOG("enableVideo() !!!");
    IRtcEngine* cobj = (IRtcEngine*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_extension_agoraCreator_enableVideo: Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 0) {
        int ret = cobj->enableVideo();
        ok &= int32_to_seval(ret, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_agoraCreator_enableVideo : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
...
static bool js_cocos2dx_extension_agoraCreator_setVideoProfile(se::State& s)
{
    CCLOG("enableVideo() !!!");
    IRtcEngine* cobj = (IRtcEngine*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_extension_agoraCreator_setVideoProfile: Invalid Native Object");
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        int ret = cobj->setVideoProfile((agora::rtc::VIDEO_PROFILE_TYPE)profile, false);
        ok &= int32_to_seval(ret, &s.rval());
        SE_PRECONDITION2(ok, false, "js_cocos2dx_extension_agoraCreator_setVideoProfile : Error processing arguments");
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 0);
    return false;
}
SE_BIND_FUNC(js_cocos2dx_extension_agoraCreator_setVideoProfile)
...
static bool js_cocos2dx_extension_agoraCreator_setParameters(se::State& s) {
    ...
    if (argc == 1)
    {
        ...
        AParameter aparameter(cobj);
        int ret = aparameter->setParameters(sStr.c_str());
        int32_to_seval(ret, &s.rval());
...
static bool js_cocos2dx_extension_agoraCreator_enableVideoObserver(se::State& s) {
    CCLOG("enableVideoObserver() !!!");
    IRtcEngine* cobj = (IRtcEngine*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_extension_agoraCreator_setParameters: Invalid Native Object");
    if (!(g_SingleInstance->_myVideoRawDataControl))
    {
        g_SingleInstance->_myVideoRawDataControl = new agora::cocos::MyVideoRawDataControl();
        CCLOG("js_cocos2dx_extension_agoraCreator_enableVideoObserver() new  myVideoRawData");
    }
    agora::util::AutoPtr<agora::media::IMediaEngine> mediaEngine;
    mediaEngine.queryInterface(cobj, agora::AGORA_IID_MEDIA_ENGINE);
    int ret = -100;
    if (mediaEngine)
    {
        ret = mediaEngine->registerVideoFrameObserver(g_SingleInstance->_myVideoRawDataControl);
        int32_to_seval(ret, &s.rval());
    }
    CCLOG("js_cocos2dx_extension_agoraCreator_enableVideoObserver() !!! ret = %d", ret);
    return true;
}
SE_BIND_FUNC(js_cocos2dx_extension_agoraCreator_enableVideoObserver)

static bool js_cocos2dx_extension_agoraCreator_disableVideoObserver(se::State& s) {
    CCLOG("disableVideoObserver() !!!");
    IRtcEngine* cobj = (IRtcEngine*)s.nativeThisObject();
    SE_PRECONDITION2(cobj, false, "js_cocos2dx_extension_agoraCreator_setParameters: Invalid Native Object");
    agora::util::AutoPtr<agora::media::IMediaEngine> mediaEngine;
    mediaEngine.queryInterface(cobj, agora::AGORA_IID_MEDIA_ENGINE);
    ...
    if (g_SingleInstance->_myVideoRawDataControl)
    {
        delete  g_SingleInstance->_myVideoRawDataControl;
        g_SingleInstance->_myVideoRawDataControl = NULL;
    }
    int32_to_seval(ret, &s.rval());
    return true;
}
...
static bool js_cocos2dx_extension_agoraCreator_updateTexture(se::State& s) {
    IRtcEngine* cobj = (IRtcEngine*)s.nativeThisObject();
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    ...
    {
        uint32_t glId;
        ok &= seval_to_uint32(args[0], &glId);
        ...
        if (g_SingleInstance->_myVideoRawDataControl)
        {
            ret = g_SingleInstance->_myVideoRawDataControl->updateTexture(glId, uid);
        }
...
bool js_register_cocos2dx_extension_agoraCreator(se::Object* obj)
{
    ...
    cls->defineFunction("setVideoProfile", _SE(js_cocos2dx_extension_agoraCreator_setVideoProfile));
