...
cc.Class({
    ...
    onUserJoined: function (uid, elapsed) {
        this.printfLog(this.tag, "receive message onUserJoined uid = " + uid + " ,elapsed = " + elapsed);
        agoraEngine.setupRemoteVideo(uid, "RemoteVideoDiv");
    },

    onJoinChannelSuccess: function (channel, uid, elapsed) {
        this.printfLog(this.tag, "onJoinChannelSuccess channel = " + channel + " ,uid = " + uid);
    },
